...
const AnalysisHistory = ({ userId, analyses: propAnalyses }: AnalysisHistoryProps) => {
  const [analyses, setAnalyses] = useState<Analysis[]>(propAnalyses || []);
  const [loading, setLoading] = useState(false);

  // Update internal state when propAnalyses changes
  useEffect(() => {
    console.log('=== ANALYSIS HISTORY PROP UPDATE ===');
    console.log('propAnalyses:', propAnalyses);
    console.log('propAnalyses length:', propAnalyses?.length);
    
    if (propAnalyses) {
      setAnalyses(propAnalyses);
      setLoading(false);
      console.log('Updated internal analyses state with prop data');
    }
  }, [propAnalyses]);

  useEffect(() => {
    if (userId && !propAnalyses) {
      fetchAnalyses();
    }
  }, [userId, propAnalyses]);
  ...
  console.log('=== ANALYSIS HISTORY RENDER ===');
  console.log('Current analyses state:', analyses);
